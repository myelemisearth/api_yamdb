# Generated by Django 3.0.5 on 2021-01-19 20:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(choices=[(None, 'No rating'), (1, 'Poor'), (2, 'Average'), (3, 'Good'), (4, 'Very Good'), (5, 'Excellent')], default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='api_v1.Titles')),
            ],
            options={
                'ordering': ('author',),
            },
